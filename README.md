...
```
wget -N --no-check-certificate -q -O install.sh "https://github.com/RandomKino/V2Ray_ws-tls_bash_onekey/blob/master/install.sh" && chmod +x install.sh && bash install.sh
```
